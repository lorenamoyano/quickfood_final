            ...
            <form method="POST" action="{{ route('register') }}" class="formulario_register" onsubmit="return validar_registro()">
                ...
                <div class="form-row">
                    <div class="col-md-6 input-icons">
                        ...
                        <small style="visibility: hidden;" id="apellido1Help" class="form-text text-danger">Campo alfanumérico y obligatorio</small>
                        @error('apellido1')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-md-6 input-icons">
                        ...
                        <small style="visibility: hidden;" id="apellido2Help" class="form-text text-danger">Campo alfanumérico y obligatorio</small>
                        @error('apellido2')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group row">
                    <div class="col-md-12 input-icons">
                        ...
                        <small style="visibility: hidden;" id="emailHelp" class="form-text text-danger">Campo alfanumérico y obligatorio</small>
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-row">
                    <div class="col-md-6 input-icons">
                        ...
                        <small style="visibility: hidden;" id="passwordHelp" class="form-text text-danger">Campo alfanumérico y obligatorio</small>
                        @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-md-6 input-icons">
                        ...
                        <small style="visibility: hidden;" id="password-confirmHelp" class="form-text text-danger">Campo alfanumérico y obligatorio</small>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    <div class="col-md-12 input-icons">
                        ...
                        <small style="visibility: hidden;" id="ciudadHelp" class="form-text text-danger">Campo alfanumérico y obligatorio</small>
