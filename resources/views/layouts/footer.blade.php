...
<body id="main">
    ...
    <i class="fab fa-twitter icon-center" style="color:black"></i>
    <i class="fab fa-instagram icon-center" style="color:black"></i>
    <i class="fab fa-youtube icon-center" style="color:black"></i>
    </div>
</div>
    </div>
</body>
